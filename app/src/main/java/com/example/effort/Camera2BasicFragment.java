...
//    };
    ...
    private void setUpCameraOutputs(int width, int height,int faningId) {
        Activity activity = getActivity();
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                if (facing != null && facing ==faningId) {
    ...
    private void openCamera(int width, int height) {
        ...
        setUpCameraOutputs(width, height,faningId);
        configureTransform(width, height);
        Activity activity = getActivity();
        CameraManager manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
        try {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.change: {
                if(faningId==CameraCharacteristics.LENS_FACING_FRONT){
                    faningId=CameraCharacteristics.LENS_FACING_BACK;
                }else {
                    faningId=CameraCharacteristics.LENS_FACING_FRONT;
                }
                closeCamera();
                openCamera(mTextureView.getWidth(), mTextureView.getHeight());
                break;
